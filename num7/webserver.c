...
void send_msg(int client_sock) { // send to all
	...
	char contentlength[] = "Content-Length: 180\r\n";
	char contenttype[] = "Content-Type:text/html\r\n";
	char html[] = "<html><head><center><H1>Notice</H1><center></head><body><center>Final exam tomorrow!</center></body><body><center>Let's study for the exam!</center></body></html>\r\n";
	char end[]="\r\n";
